 ...
 <%
  ...
  <div class="sidebar">
   ...
   <div class="container my-5">
      <h2>Delete Customer Reservation</h2>   
      <form action="remove" method="post">
          ...
          <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="bno" value="<%= bno %>">
                </div>
          </div>
          ...
          <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Departure time</label><div class="col-sm-6">
                    <input type="text" class="form-control" name="dtime" value="<%= dtime %>">
                </div>
          </div>
          ...
          <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="atime" value="<%= atime %>">
                </div>
          </div>
          ...
          <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="sno" value="<%= sno %>">
                </div>
          </div><br>
      
          <div class="row mt-4">
                <div class="col-sm-6 offset-sm-3">
                      <input type="submit" class="btn btn-danger" name="submit" value="Delete Reservation Data">
                </div>
          </div>    
