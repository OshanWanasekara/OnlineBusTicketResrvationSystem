...
public class AddScheduleServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue=ScheduleDBUtill.insertschedule(scheduleID, departureLocation, arrivalLocation, departureDate,departureTime, arrivalDate, arrivalTime,busName, busType, routeNo, route, availableSeat, totalSeat, ticketPrice);
		
		if(isTrue==true) {
			
			RequestDispatcher dis=request.getRequestDispatcher("ScheduleList.jsp");
