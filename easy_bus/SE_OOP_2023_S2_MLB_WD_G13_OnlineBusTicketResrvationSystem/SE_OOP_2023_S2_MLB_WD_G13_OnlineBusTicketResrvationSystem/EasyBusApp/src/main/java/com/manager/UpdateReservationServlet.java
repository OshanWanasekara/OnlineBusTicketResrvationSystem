...
public class UpdateReservationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = myResDBUtil.updatereservation(ref_id, user_name, travel_name, bus_type, model, bus_no, date, dep_location, arr_location, dep_time, arr_time, seat_no);
		...
		if(isTrue == true) {
			...
			RequestDispatcher dis = request.getRequestDispatcher("ResUnsuccess.jsp");
			dis.forward(request, response);
		} 
